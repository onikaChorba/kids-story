...
import { Home, NewsPage, AboutCenterPage, ExtraServices, OurTeamPage, Reviews, DocumentsAndCertificates, ParentsFAQ, Meals, SyllabusPage, ScheduleMainPage } from "./pages";
